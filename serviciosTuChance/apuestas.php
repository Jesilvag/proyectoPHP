...
$app->post('/api/apuestas',function() use ($app){
    ...
    $phql="INSERT INTO apuestas(valor_apuesta,valor_premio,fecha,numero,serie,loteria) VALUES(:valor_apuesta:,:valor_premio:,:fecha:,:numero:,:serie:,:loteria:,:nombre:,22)";
